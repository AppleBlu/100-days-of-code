...
# Url of zillow website
zillow_url = 'https://www.zillow.com/san-francisco-ca/rentals/?searchQueryState=%7B%22pagination%22%3A%7B%7D' \
...
# For loop to add the urls of each listing
url_list = []
...
print("START SENDING")
g = GoogleForm()
g.update_form(complete_pages_address_list, complete_pages_price_list, complete_pages_link_list)
